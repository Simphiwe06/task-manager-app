...
var require_markdown_table = __commonJS({
  "node_modules/markdown-table/index.js"(exports, module) {
    ...
    function toAlignment(value) {
      ...
      return code === L || code === l ? l : code === R2 || code === r2 ? r2 : code === C || code === c ? c : x;
    }
  }
});
      ...
      return function(e2, i) {
        ...
        r2.startOf = function(e3, i2) {
          ...
          if (r3.p(e3) === n2) {
            ...
            return s2 ? this.month(3 * o2).startOf(t).startOf("day") : this.month(3 * o2 + 2).endOf(t).endOf("day");
          }
...
var require_ArrowLeftOutlined2 = __commonJS({
  "node_modules/@ant-design/icons/lib/icons/ArrowLeftOutlined.js"(exports) {
    ...
    var RefIcon = _react.forwardRef(ArrowLeftOutlined2);
    if (true) {
...
var require_ArrowRightOutlined2 = __commonJS({
  "node_modules/@ant-design/icons/lib/icons/ArrowRightOutlined.js"(exports) {
    ...
    var RefIcon = _react.forwardRef(ArrowRightOutlined2);
    if (true) {
...
var r = (e2, o2) => Jr2(e2, "name", { value: o2, configurable: true });
var Te = r(({ action: e2, resource: o2, onMutationSuccess: s, onMutationError: t, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: d, successNotification: u, errorNotification: y, meta: l, metaData: g, queryMeta: m, mutationMeta: f, liveMode: b, liveParams: p, mutationMode: T, dataProviderName: P, onLiveEvent: C, invalidates: v, undoableTimeout: h, queryOptions: S2, createMutationOptions: B, updateMutationOptions: L, id: k, overtimeOptions: c, optimisticUpdateMap: E, disableServerSideValidation: I = false } = {}) => {
  var se2, ee;
  let { options: U } = se(), Z2 = (U == null ? void 0 : U.disableServerSideValidation) || I, x = G(), [_] = form_default.useForm(), Q = useForm({ form: _ }), { form: H } = Q, V = XR({ onMutationSuccess: s || void 0, onMutationError: async (M, oe, te2) => {
    if (Z2) {
      t == null || t(M, oe, te2);
      return;
    }
    let q = [], de = H.getFieldsValue();
    q = Object.keys(ir(de)).map((xe) => ({ name: Jo(xe), errors: void 0 })), H.setFields(q);
    let Ne = M == null ? void 0 : M.errors;
    for (let xe in Ne) {
      let ye = Ne[xe], Qe = [];
      Array.isArray(ye) && (Qe = ye), typeof ye == "string" && (Qe = [ye]), typeof ye == "boolean" && ye && (Qe = ["Field is not valid."]), typeof ye == "object" && "key" in ye && (Qe = [x(ye.key, ye.message)]), q.push({ name: Jo(xe), errors: Qe });
    }
    H.setFields([...q]), t == null || t(M, oe, te2);
  }, redirect: d, action: e2, resource: o2, successNotification: u, errorNotification: y, meta: S(l, g), metaData: S(l, g), queryMeta: m, mutationMeta: f, liveMode: b, liveParams: p, mutationMode: T, dataProviderName: P, onLiveEvent: C, invalidates: v, undoableTimeout: h, queryOptions: S2, createMutationOptions: B, updateMutationOptions: L, id: k, overtimeOptions: c, optimisticUpdateMap: E, autoSave: n2 }), { formLoading: X, onFinish: F, queryResult: D, id: O, onFinishAutoSave: z2 } = V, { warnWhenUnsavedChanges: Y, setWarnWhen: G2 } = pt(), A = a ?? Y;
  import_react74.default.useEffect(() => {
    H.resetFields();
  }, [(se2 = D == null ? void 0 : D.data) == null ? void 0 : se2.data, O]);
  let K = r((M) => {
    i && M.key === "Enter" && H.submit();
  }, "onKeyUp"), j = r((M, oe) => {
    if (M && A && G2(true), n2 != null && n2.enabled) {
      G2(false);
      let te2 = (n2 == null ? void 0 : n2.onFinish) ?? ((q) => q);
      return z2(te2(oe)).catch((q) => q);
    }
    return M;
  }, "onValuesChange"), J2 = { disabled: X, onClick: () => {
    H.submit();
  } };
  return { form: Q.form, formProps: { ...Q.formProps, onFinish: (M) => F(M).catch((oe) => oe), onKeyUp: K, onValuesChange: j, initialValues: (ee = D == null ? void 0 : D.data) == null ? void 0 : ee.data }, saveButtonProps: J2, ...V, onFinish: async (M) => await F(M ?? Q.form.getFieldsValue(true)) };
}, "useForm");
var er = r(({ modalProps: e2 = {} } = {}) => {
  let { show: o2, close: s, visible: t } = Oh({ defaultVisible: e2.open });
  return { modalProps: { ...e2, onCancel: (n2) => {
    var i;
    (i = e2.onCancel) == null || i.call(e2, n2), s();
  }, open: t, visible: t }, show: o2, close: s };
}, "useModal");
var rr = r(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: s = true, autoResetForm: t = true, autoSave: n2, invalidates: i, ...a }) => {
  var G2, A;
  let [d, u] = import_react75.default.useState(false), y = Ce(), { resource: l, action: g, identifier: m } = z(a.resource), f = ae(), b = ge(), p = st(), T = a.action ?? g ?? "", P = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : l && T && e2 ? `modal-${m}-${T}` : void 0, v = Te({ meta: { ...C ? { [C]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: h, formProps: S2, id: B, setId: L, formLoading: k, onFinish: c, autoSaveProps: E } = v, I = G(), { warnWhen: U, setWarnWhen: Z2 } = pt(), { show: x, close: _, modalProps: Q } = er({ modalProps: { open: o2 } }), H = Q.open || false, V = { modalProps: Q, form: h, formLoading: k, formProps: S2, formResult: void 0, formValues: h.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: c, close: _, open: Q.open || false, show: x, visible: H };
  import_react75.default.useEffect(() => {
    ...
    var K;
    d === true && (H && C ? b({ query: { [C]: { ...(K = f == null ? void 0 : f.params) == null ? void 0 : K[C], open: true, ...P && B && { id: B } } }, options: { keepQuery: true }, type: "replace" }) : C && !H && b({ query: { [C]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [B, H, x, C, P]);
  let X = { disabled: k, loading: k, onClick: () => {
    h.submit();
  } }, F = (0, import_react75.useCallback)(() => {
    if (E.status === "success" && (n2 != null && n2.invalidateOnClose) && y({ id: B, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: m }), U)
  ...
  }, [U, E.status]), D = (0, import_react75.useCallback)((K) => {
    typeof K < "u" && (L == null || L(K)), (!(T === "edit" || T === "clone") || (typeof K < "u" || typeof B < "u")) && V.show();
  }, [B]), { visible: O, ...z2 } = Q, Y = { open: O, ...z2 };
  return { ...v, ...V, show: D, close: F, open: H, formProps: { ...S2, ...v.formProps, onValuesChange: S2 == null ? void 0 : S2.onValuesChange, onKeyUp: S2 == null ? void 0 : S2.onKeyUp, onFinish: async (K) => {
    await c(K), s && _(), t && h.resetFields();
  } }, modalProps: { ...Y, width: "1000px", okButtonProps: X, title: I(`${m}.titles.${a.action}`, `${p(`${a.action} ${((G2 = l == null ? void 0 : l.meta) == null ? void 0 : G2.label) ?? ((A = l == null ? void 0 : l.options) == null ? void 0 : A.label) ?? (l == null ? void 0 : l.label) ?? m}`, "singular")}`), okText: I("buttons.save", "Save"), cancelText: I("buttons.cancel", "Cancel"), onCancel: F, forceRender: true }, formLoading: k };
}, "useModalForm");
var sr = r(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: s = true, autoResetForm: t = true, autoSave: n2, invalidates: i, ...a }) => {
  let d = Ce(), [u, y] = import_react76.default.useState(false), { visible: l, show: g, close: m } = Oh({ defaultVisible: o2 }), { resource: f, action: b, identifier: p } = z(a.resource), T = ae(), P = ge(), C = a.action ?? b ?? "", v = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), h = typeof e2 == "object" && "key" in e2 ? e2.key : f && C && e2 ? `drawer-${(f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name)}-${C}` : void 0, S2 = Te({ meta: { ...h ? { [h]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: B, formProps: L, formLoading: k, id: c, setId: E, onFinish: I, autoSaveProps: U } = S2;
  import_react76.default.useEffect(() => {
    var F, D, O, z2;
    if (u === false && h) {
      let Y = (D = (F = T == null ? void 0 : T.params) == null ? void 0 : F[h]) == null ? void 0 : D.open;
      if (typeof Y == "boolean" ? Y ? g() : m() : typeof Y == "string" && Y === "true" && g(), v) {
        let G2 = (z2 = (O = T == null ? void 0 : T.params) == null ? void 0 : O[h]) == null ? void 0 : z2.id;
        G2 && (E == null || E(G2));
      }
      y(true);
    }
  }, [h, T, v, E, u]), import_react76.default.useEffect(() => {
    var F;
    u === true && (l && h ? P({ query: { [h]: { ...(F = T == null ? void 0 : T.params) == null ? void 0 : F[h], open: true, ...v && c && { id: c } } }, options: { keepQuery: true }, type: "replace" }) : h && !l && P({ query: { [h]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [c, l, g, m, h, v, u]);
  let Z2 = G(), { warnWhen: x, setWarnWhen: _ } = pt(), Q = { disabled: k, onClick: () => {
    B.submit();
  }, loading: k }, H = { recordItemId: c, onSuccess: () => {
    E == null || E(void 0), m();
    ...
    if (U.status === "success" && (n2 != null && n2.invalidateOnClose) && d({ id: c, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: p }), x)
      if (window.confirm(Z2("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        ...
        return;
    m(), E == null || E(void 0);
  }, [x]), X = (0, import_react76.useCallback)((F) => {
    typeof F < "u" && (E == null || E(F)), (!(C === "edit" || C === "clone") || (typeof F < "u" || typeof c < "u")) && g();
  }, [c]);
  return { ...S2, show: X, close: V, formProps: { form: B, ...S2.formProps, onValuesChange: L == null ? void 0 : L.onValuesChange, onKeyUp: L == null ? void 0 : L.onKeyUp, onFinish: async (F) => {
    await I(F), s && m(), t && B.resetFields();
  } }, drawerProps: { width: "500px", onClose: V, open: l, forceRender: true }, saveButtonProps: Q, deleteButtonProps: H, formLoading: k };
}, "useDrawerForm");
var nr = r((e2 = {}) => {
  let o2 = Te({ ...e2 }), { form: s, formProps: t } = o2, n2 = useStepsForm({ isBackValidate: false, form: s, submit: (i) => {
    var a;
    (a = t == null ? void 0 : t.onFinish) == null || a.call(t, i);
  }, ...e2 });
  return { ...o2, ...n2, formLoading: o2.formLoading, formProps: { ...n2.formProps, ...o2.formProps, onValuesChange: t == null ? void 0 : t.onValuesChange, onKeyUp: t == null ? void 0 : t.onKeyUp }, saveButtonProps: { ...o2.saveButtonProps, onClick: () => n2.submit() } };
}, "useStepsForm");
var vt = r((e2, o2) => {
  let s = na(e2, o2);
  if (s)
...
var Lt = r((e2, o2, s = "eq") => sa(e2, o2, s), "getDefaultFilter");
var fo = r((e2) => {
  let o2 = [];
  if (Array.isArray(e2))
    e2.sort((s, t) => {
      var n2, i;
      return (((n2 = s.column) == null ? void 0 : n2.sorter).multiple ?? 0) < (((i = t.column) == null ? void 0 : i.sorter).multiple ?? 0) ? -1 : 0;
    }).map((s) => {
      if (s.field && s.order) {
        let t = Array.isArray(s.field) ? s.field.join(".") : `${s.field}`;
        o2.push({ field: `${s.columnKey ?? t}`, order: s.order.replace("end", "") });
      }
    });
...
var yo = r((e2, o2, s) => {
  ...
  return Object.keys(e2).map((i) => {
    ...
    d !== "or" && d !== "and" && t.push({ field: i, operator: d ?? (Array.isArray(a) ? "in" : "eq"), value: a });
  }), t;
}, "mapAntdFilterToCrudFilter");
var he = r(({ to: e2, element: o2 }) => {
  let { Link: s } = te(), t = Z(), n2 = rt();
  return import_react78.default.createElement(t === "legacy" ? s : n2, { to: e2, replace: false, onClick: (a) => {
    a.preventDefault();
  } }, o2);
}, "PaginationLink");
var go = r(({ onSearch: e2, initialCurrent: o2, initialPageSize: s, hasPagination: t = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: d, permanentFilter: u, defaultSetFilterBehavior: y, filters: l, sorters: g, syncWithLocation: m, resource: f, successNotification: b, errorNotification: p, queryOptions: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: h, metaData: S2, dataProviderName: B } = {}) => {
  let { tableQueryResult: L, current: k, setCurrent: c, pageSize: E, setPageSize: I, filters: U, setFilters: Z2, sorters: x, setSorters: _, sorter: Q, setSorter: H, createLinkForSyncWithLocation: V, pageCount: X, overtime: F } = cb({ permanentSorter: a, permanentFilter: u, initialCurrent: o2, initialPageSize: s, pagination: n2, hasPagination: t, filters: l, sorters: g, initialSorter: i, initialFilter: d, syncWithLocation: m, resource: f, defaultSetFilterBehavior: y, successNotification: b, errorNotification: p, queryOptions: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: S(h, S2), metaData: S(h, S2), dataProviderName: B }), D = grid_default.useBreakpoint(), [O] = form_default.useForm(), z2 = useForm({ form: O }), Y = Bn(P), G2 = t === false ? "off" : "server", A = ((n2 == null ? void 0 : n2.mode) ?? G2) !== "off", K = S(l == null ? void 0 : l.initial, d), { data: j, isFetched: J2, isLoading: se2 } = L, ee = r((te2, q, de) => {
    ...
    A && (c == null || c(te2.current || 1), I == null || I(te2.pageSize || 10));
  }, "onChange"), M = r(async (te2) => {
    if (e2) {
      let q = await e2(te2);
      Z2(q), A && (c == null || c(1));
    }
  }, "onFinish"), oe = r(() => A ? { itemRender: (te2, q, de) => {
    var Ne;
    let ue = V({ pagination: { pageSize: E, current: te2 }, sorters: x, filters: U });
    if (q === "page")
      return (0, import_react77.createElement)(he, { to: ue, element: `${te2}` });
    if (q === "next" || q === "prev")
      return (0, import_react77.createElement)(he, { to: ue, element: de });
    if (q === "jump-next" || q === "jump-prev") {
    ...
    return de;
  }, pageSize: E, current: k, simple: !D.sm, position: D.sm ? ["bottomRight"] : ["bottomCenter"], total: j == null ? void 0 : j.total } : false, "antdPagination");
  return { searchFormProps: { ...z2.formProps, onFinish: M }, tableProps: { dataSource: j == null ? void 0 : j.data, loading: Y === "auto" ? se2 : !J2, onChange: ee, pagination: oe(), scroll: { x: true } }, tableQueryResult: L, sorters: x, sorter: Q, filters: U, setSorters: _, setSorter: H, setFilters: Z2, current: k, setCurrent: c, pageSize: E, setPageSize: I, pageCount: X, createLinkForSyncWithLocation: V, overtime: F };
}, "useTable");
var Mt = r(({ autoSubmitClose: e2 = true, ...o2 } = {}) => {
  let s = go({ ...o2, successNotification: void 0, errorNotification: void 0 }), t = Te({ ...o2, action: "edit", redirect: false }), { id: n2, setId: i, saveButtonProps: a } = t, d = { onClick: () => {
    i(void 0);
  } }, u = r((l) => ({ onClick: () => i(l) }), "editButtonProps"), y = r((l) => l === n2, "isEditing");
  return { ...s, ...t, formProps: { ...t.formProps, onFinish: async (l) => {
    let g = await t.onFinish(l);
    return e2 && i(void 0), g;
  } }, saveButtonProps: a, cancelButtonProps: d, editButtonProps: u, isEditing: y };
}, "useEditableTable");
var Jm = r((e2) => {
  let { queryResult: o2, defaultValueQueryResult: s, onSearch: t, options: n2 } = XC(e2);
  return { selectProps: { options: n2, onSearch: t, loading: s.isFetching, showSearch: true, filterOption: false }, queryResult: o2, defaultValueQueryResult: s };
}, "useSelect");
var pc = r(({ resource: e2, sort: o2, sorters: s, filters: t, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: f, metaData: b, dataProviderName: p }) => {
  let { queryResult: T, options: P } = XC({ resource: e2, sort: o2, sorters: s, filters: t, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: S(f, b), metaData: S(f, b), dataProviderName: p });
  return { checkboxGroupProps: { options: P, defaultValue: l }, queryResult: T };
}, "useCheckboxGroup");
var xc = r(({ resource: e2, sort: o2, sorters: s, filters: t, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: f, metaData: b, dataProviderName: p }) => {
  let { queryResult: T, options: P } = XC({ resource: e2, sort: o2, sorters: s, filters: t, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: S(f, b), metaData: S(f, b), dataProviderName: p });
  return { radioGroupProps: { options: P, defaultValue: l }, queryResult: T };
}, "useRadioGroup");
var Dc = r(({ resource: e2, resourceName: o2, mapData: s = r((l) => l, "mapData"), paparseOptions: t, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: d, dataProviderName: u, onProgress: y } = {}) => {
  let l = G(), { resource: g } = z(e2 ?? o2), { mutationResult: m, isLoading: f, handleChange: b } = Gh({ resource: (g == null ? void 0 : g.identifier) ?? (g == null ? void 0 : g.name), mapData: s, paparseOptions: t, batchSize: n2, meta: S(a, d), metaData: S(a, d), dataProviderName: u, onFinish: i, onProgress: y ?? (({ totalAmount: p, processedAmount: T }) => {
    if (p > 0 && T > 0) {
...
var Jt = r(({ resource: e2, initialCurrent: o2, initialPageSize: s, pagination: t, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: d, permanentFilter: u, defaultSetFilterBehavior: y, filters: l, sorters: g, onSearch: m, queryOptions: f, syncWithLocation: b, successNotification: p, errorNotification: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: h, metaData: S2, dataProviderName: B } = {}) => {
  let { sorters: L, sorter: k, filters: c, current: E, pageSize: I, pageCount: U, setFilters: Z2, setCurrent: x, setPageSize: _, setSorter: Q, setSorters: H, createLinkForSyncWithLocation: V, tableQueryResult: X, overtime: F } = cb({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: d, permanentFilter: u, filters: l, sorters: g, defaultSetFilterBehavior: y, initialCurrent: o2, initialPageSize: s, queryOptions: f, successNotification: p, errorNotification: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: S(h, S2), metaData: S(h, S2), syncWithLocation: b, dataProviderName: B, pagination: t, hasPagination: n2 }), D = n2 === false ? "off" : "server", O = ((t == null ? void 0 : t.mode) ?? D) !== "off", z2 = grid_default.useBreakpoint(), Y = Bn(P), [G2] = form_default.useForm(), { data: A, isFetched: K, isLoading: j } = X, J2 = r((M, oe) => {
    O && (x(M), _(oe || 10));
  }, "onChange"), se2 = r(async (M) => {
    if (m) {
      let oe = await m(M);
      return O && (x == null || x(1)), Z2(oe);
    }
  }, "onFinish"), ee = r(() => O ? { itemRender: (M, oe, te2) => {
    var de;
    let q = V({ pagination: { pageSize: I, current: M }, sorters: L, filters: c });
    if (oe === "page")
      return (0, import_react80.createElement)(he, { to: q, element: `${M}` });
    if (oe === "next" || oe === "prev")
      return (0, import_react80.createElement)(he, { to: q, element: te2 });
    if (oe === "jump-next" || oe === "jump-prev") {
      let ue = (de = te2 == null ? void 0 : te2.props) == null ? void 0 : de.children;
      return (0, import_react80.createElement)(he, { to: q, element: import_react80.Children.count(ue) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, ue) : ue });
    }
    return te2;
  }, pageSize: I, current: E, simple: !z2.sm, total: A == null ? void 0 : A.total, onChange: J2 } : false, "antdPagination");
  return { searchFormProps: { form: G2, onFinish: se2 }, listProps: { dataSource: A == null ? void 0 : A.data, loading: Y === "auto" ? j : !K, pagination: ee() }, queryResult: X, filters: c, setFilters: Z2, sorter: k, setSorter: Q, sorters: L, setSorters: H, current: E, setCurrent: x, pageSize: I, setPageSize: _, pageCount: U, createLinkForSyncWithLocation: V, overtime: F };
}, "useSimpleList");
var Zc = r(() => {
  let [e2, o2] = (0, import_react81.useState)(false), s = (0, import_react81.useCallback)((t) => {
    ts(t.fileList).includes(true) ? o2(true) : o2(false);
  }, []);
  return (0, import_react81.useMemo)(() => ({ isLoading: e2, onChange: s }), [e2]);
}, "useFileUploadState");
var ts = r((e2) => e2.map((o2) => {
  switch (o2.status) {
    case "uploading":
      return true;
    default:
...
var xo = r(({ children: e2, initialSiderCollapsed: o2 }) => {
  let [s, t] = (0, import_react83.useState)(o2 ?? false), [n2, i] = (0, import_react83.useState)(false);
  return import_react83.default.createElement(Ie.Provider, { value: { siderCollapsed: s, mobileSiderOpen: n2, setSiderCollapsed: t, setMobileSiderOpen: i } }, e2);
}, "ThemedLayoutContextProvider");
var pf = r(() => {
  let { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: s, setSiderCollapsed: t } = (0, import_react82.useContext)(Ie);
  return { siderVisible: e2, setSiderVisible: s, drawerSiderVisible: o2, setDrawerSiderVisible: t };
}, "useSiderVisible");
var cr = r(() => {
  let { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: s, setSiderCollapsed: t } = (0, import_react84.useContext)(Ie);
  return { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: s, setSiderCollapsed: t };
}, "useThemedLayoutContext");
var ho = r(({ message: e2, cancelMutation: o2, undoableTimeout: s }) => import_react86.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react86.default.createElement(progress_default, { type: "circle", percent: (s ?? 0) * 20, format: (t) => t && t / 20, size: 50, strokeColor: "#1890ff", status: "normal" }), import_react86.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, e2), import_react86.default.createElement(button_default, { style: { flexShrink: 0 }, onClick: o2, disabled: s === 0, icon: import_react86.default.createElement(UndoOutlined_default, null) })), "UndoableNotification");
var Bf = { open: ({ key: e2, message: o2, description: s, type: t, cancelMutation: n2, undoableTimeout: i }) => {
  t === "progress" ? notification_default.open({ key: e2, description: import_react85.default.createElement(ho, { notificationKey: e2, message: o2, cancelMutation: () => {
    n2 == null || n2(), notification_default.destroy(e2 ?? "");
  }, undoableTimeout: i }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : notification_default.open({ key: e2, description: o2, message: s ?? null, type: t });
}, close: (e2) => notification_default.destroy(e2) };
var Sf = r(() => {
  let { notification: e2 } = app_default.useApp(), o2 = "open" in e2 ? e2 : notification_default;
  return { open: ({ key: t, message: n2, description: i, type: a, cancelMutation: d, undoableTimeout: u }) => {
    a === "progress" ? o2.open({ key: t, description: import_react85.default.createElement(ho, { notificationKey: t, message: n2, cancelMutation: () => {
      d == null || d(), o2.destroy(t ?? "");
    }, undoableTimeout: u }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : o2.open({ key: t, description: n2, message: i ?? null, type: a });
  }, close: (t) => o2.destroy(t) };
}, "useNotificationProvider");
var fr2 = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Co = r(({ Title: e2, render: o2, meta: s }) => {
  let [t, n2] = (0, import_react88.useState)(false), [i, a] = (0, import_react88.useState)(false), d = Jr(), u = Z(), y = rt(), { warnWhen: l, setWarnWhen: g } = pt(), { Link: m } = te(), f = u === "legacy" ? m : y, b = Js(), p = G(), { menuItems: T, selectedKey: P, defaultOpenKeys: C } = Cu({ meta: s }), v = grid_default.useBreakpoint(), { hasDashboard: h } = se(), S2 = J(), { mutate: B } = fr({ v3LegacyAuthProviderCompatible: !!(S2 != null && S2.isLegacy) }), L = typeof v.lg > "u" ? false : !v.lg, k = e2 ?? b ?? Fo, c = r((V, X) => V.map((F) => {
    let { icon: D, label: O, route: z2, key: Y, name: G2, children: A, parentName: K, meta: j, options: J2 } = F;
    if (A.length > 0)
      return import_react88.default.createElement(nc, { key: F.key, resource: G2.toLowerCase(), action: "list", params: { resource: F } }, import_react88.default.createElement(menu_default.SubMenu, { key: F.key, icon: D ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: O }, c(A, X)));
    let se2 = Y === X, ee = !(S(j == null ? void 0 : j.parent, J2 == null ? void 0 : J2.parent, K) !== void 0 && A.length === 0);
    return import_react88.default.createElement(nc, { key: F.key, resource: G2.toLowerCase(), action: "list", params: { resource: F } }, import_react88.default.createElement(menu_default.Item, { key: F.key, style: { fontWeight: se2 ? "bold" : "normal" }, icon: D ?? (ee && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(f, { to: z2 ?? "" }, O), !t && se2 && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), E = r(() => {
    l ? window.confirm(p("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (g(false), B()) : B();
  }, "handleLogout"), I = d && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: E, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, p("buttons.logout", "Logout")), U = h ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: P === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(f, { to: "/" }, p("dashboard.title", "Dashboard")), !t && P === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, Z2 = c(T, P), x = r(() => o2 ? o2({ dashboard: U, items: Z2, logout: I, collapsed: t }) : import_react88.default.createElement(import_react88.default.Fragment, null, U, Z2, I), "renderSider"), _ = r(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: P ? [P] : [], defaultOpenKeys: C, mode: "inline", onClick: () => {
    a(false), v.lg || n2(true);
  } }, x())), "renderMenu"), Q = r(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(k, { collapsed: false }), _()))), import_react88.default.createElement(button_default, { style: fr2, size: "large", onClick: () => a(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react88.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, r(() => L ? Q() : import_react88.default.createElement(layout_default.Sider, { collapsible: true, collapsed: t, onCollapse: (V) => n2(V), collapsedWidth: 80, breakpoint: "lg" }, import_react88.default.createElement(k, { collapsed: t }), _()), "renderContent")());
}, "Sider");
var Bo = r(() => {
  let e2 = J(), { data: o2 } = $r({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
...
var Hs = r(({ children: e2, Header: o2, Sider: s, Title: t, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), d = s ?? Co, u = o2 ?? Bo, y = typeof a.sm > "u" ? true : a.sm;
  return import_react87.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react87.default.createElement(d, { Title: t }), import_react87.default.createElement(layout_default, null, import_react87.default.createElement(u, null), import_react87.default.createElement(layout_default.Content, null, import_react87.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), i && import_react87.default.createElement(i, null)), n2 && import_react87.default.createElement(n2, null)));
}, "Layout");
var Fo = r(({ collapsed: e2 }) => {
  let o2 = Z(), s = rt(), { Link: t } = te();
  return import_react90.default.createElement(o2 === "legacy" ? t : s, { to: "/" }, e2 ? import_react90.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center" } }, import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine-mini.svg", alt: "Refine", style: { margin: "0 auto", padding: "12px 0", maxHeight: "65.5px" } })) : import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine", style: { width: "200px", padding: "12px 24px" } }));
}, "Title");
var br = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Lo = r(({ Title: e2, render: o2, meta: s }) => {
  let { token: t } = theme_default.useToken(), [n2, i] = (0, import_react92.useState)(false), [a, d] = (0, import_react92.useState)(false), u = Jr(), y = Z(), l = rt(), { warnWhen: g, setWarnWhen: m } = pt(), { Link: f } = te(), b = y === "legacy" ? f : l, p = Js(), T = G(), { menuItems: P, selectedKey: C, defaultOpenKeys: v } = Cu({ meta: s }), h = grid_default.useBreakpoint(), { hasDashboard: S2 } = se(), B = J(), { mutate: L } = fr({ v3LegacyAuthProviderCompatible: !!(B != null && B.isLegacy) }), k = typeof h.lg > "u" ? false : !h.lg, c = e2 ?? p ?? ko, E = r((V, X) => V.map((F) => {
    let { icon: D, label: O, route: z2, key: Y, name: G2, children: A, parentName: K, meta: j, options: J2 } = F;
    if (A.length > 0)
      return import_react92.default.createElement(nc, { key: F.key, resource: G2.toLowerCase(), action: "list", params: { resource: F } }, import_react92.default.createElement(menu_default.SubMenu, { key: F.key, icon: D ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: O }, E(A, X)));
    let se2 = Y === X, ee = !(S(j == null ? void 0 : j.parent, J2 == null ? void 0 : J2.parent, K) !== void 0 && A.length === 0);
    return import_react92.default.createElement(nc, { key: F.key, resource: G2.toLowerCase(), action: "list", params: { resource: F } }, import_react92.default.createElement(menu_default.Item, { key: F.key, icon: D ?? (ee && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(b, { to: z2 ?? "" }, O), !n2 && se2 && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), I = r(() => {
    g ? window.confirm(T("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (m(false), L()) : L();
  }, "handleLogout"), U = u && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => I(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, T("buttons.logout", "Logout")), Z2 = S2 ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(b, { to: "/" }, T("dashboard.title", "Dashboard")), !n2 && C === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, x = E(P, C), _ = r(() => o2 ? o2({ dashboard: Z2, items: x, logout: U, collapsed: n2 }) : import_react92.default.createElement(import_react92.default.Fragment, null, Z2, x, U), "renderSider"), Q = r(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: C ? [C] : [], defaultOpenKeys: v, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    d(false), h.lg || i(true);
  } }, _())), "renderMenu"), H = r(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: a, onClose: () => d(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: t.colorBgContainer, borderRight: `1px solid ${t.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: t.colorBgElevated } }, import_react92.default.createElement(c, { collapsed: false })), Q()))), import_react92.default.createElement(button_default, { style: br, size: "large", onClick: () => d(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return k ? H() : import_react92.default.createElement(layout_default.Sider, { style: { backgroundColor: t.colorBgContainer, borderRight: `1px solid ${t.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (V) => i(V), collapsedWidth: 80, breakpoint: "lg", trigger: import_react92.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: t.colorBgElevated } }, n2 ? import_react92.default.createElement(RightOutlined_default, { style: { color: t.colorPrimary } }) : import_react92.default.createElement(LeftOutlined_default, { style: { color: t.colorPrimary } })) }, import_react92.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: t.colorBgElevated, fontSize: "14px" } }, import_react92.default.createElement(c, { collapsed: n2 })), Q());
}, "ThemedSider");
var Eo = r(() => {
  let { token: e2 } = theme_default.useToken(), o2 = J(), { data: s } = $r({ v3LegacyAuthProviderCompatible: !!(o2 != null && o2.isLegacy) });
...
var fn = r(({ children: e2, Header: o2, Sider: s, Title: t, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), d = s ?? Lo, u = o2 ?? Eo, y = typeof a.sm > "u" ? true : a.sm;
  return import_react91.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react91.default.createElement(d, { Title: t }), import_react91.default.createElement(layout_default, null, import_react91.default.createElement(u, null), import_react91.default.createElement(layout_default.Content, null, import_react91.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), i && import_react91.default.createElement(i, null)), n2 && import_react91.default.createElement(n2, null)));
}, "ThemedLayout");
...
var ko = r(({ collapsed: e2, icon: o2 = Cn, text: s = Pn, wrapperStyles: t }) => {
  let { token: n2 } = theme_default.useToken(), i = Z(), a = rt(), { Link: d } = te();
  return import_react94.default.createElement(i === "legacy" ? d : a, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react94.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...t } }, import_react94.default.createElement("div", { style: { height: "24px", width: "24px", color: n2.colorPrimary } }, o2), !e2 && import_react94.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, s)));
}, "ThemedTitle");
var Br = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Ro = r(({ Title: e2, render: o2, meta: s, fixed: t, activeItemDisabled: n2 = false }) => {
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: d, mobileSiderOpen: u, setMobileSiderOpen: y } = cr(), l = Jr(), g = Z(), m = rt(), { warnWhen: f, setWarnWhen: b } = pt(), { Link: p } = te(), T = g === "legacy" ? p : m, P = Js(), C = G(), { menuItems: v, selectedKey: h, defaultOpenKeys: S2 } = Cu({ meta: s }), B = grid_default.useBreakpoint(), { hasDashboard: L } = se(), k = J(), { mutate: c } = fr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), E = typeof B.lg > "u" ? false : !B.lg, I = e2 ?? P ?? ce2, U = r((D, O) => D.map((z2) => {
    let { icon: Y, label: G2, route: A, key: K, name: j, children: J2, parentName: se2, meta: ee, options: M } = z2;
    if (J2.length > 0)
      return import_react96.default.createElement(nc, { key: z2.key, resource: j.toLowerCase(), action: "list", params: { resource: z2 } }, import_react96.default.createElement(menu_default.SubMenu, { key: z2.key, icon: Y ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: G2 }, U(J2, O)));
    let oe = K === O, te2 = !(S(ee == null ? void 0 : ee.parent, M == null ? void 0 : M.parent, se2) !== void 0 && J2.length === 0), q = n2 && oe ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(nc, { key: z2.key, resource: j.toLowerCase(), action: "list", params: { resource: z2 } }, import_react96.default.createElement(menu_default.Item, { key: z2.key, icon: Y ?? (te2 && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: q }, import_react96.default.createElement(T, { to: A ?? "", style: q }, G2), !a && oe && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), Z2 = r(() => {
    f ? window.confirm(C("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (b(false), c()) : c();
  }, "handleLogout"), x = l && import_react96.default.createElement(menu_default.Item, { key: "logout", onClick: () => Z2(), icon: import_react96.default.createElement(LogoutOutlined_default, null) }, C("buttons.logout", "Logout")), _ = L ? import_react96.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react96.default.createElement(DashboardOutlined_default, null) }, import_react96.default.createElement(T, { to: "/" }, C("dashboard.title", "Dashboard")), !a && h === "/" && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, Q = U(v, h), H = r(() => o2 ? o2({ dashboard: _, items: Q, logout: x, collapsed: a }) : import_react96.default.createElement(import_react96.default.Fragment, null, _, Q, x), "renderSider"), V = r(() => import_react96.default.createElement(menu_default, { selectedKeys: h ? [h] : [], defaultOpenKeys: S2, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    y(false);
  } }, H()), "renderMenu"), X = r(() => import_react96.default.createElement(import_react96.default.Fragment, null, import_react96.default.createElement(drawer_default, { open: u, onClose: () => y(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react96.default.createElement(layout_default, null, import_react96.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react96.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react96.default.createElement(I, { collapsed: false })), V()))), import_react96.default.createElement(button_default, { style: Br, size: "large", onClick: () => y(true), icon: import_react96.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (E)
    return X();
  let F = { backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` };
  return t && (F.position = "fixed", F.top = 0, F.height = "100vh", F.zIndex = 999), import_react96.default.createElement(import_react96.default.Fragment, null, t && import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", transition: "all 0.2s" } }), import_react96.default.createElement(layout_default.Sider, { style: F, collapsible: true, collapsed: a, onCollapse: (D, O) => {
    O === "clickTrigger" && d(D);
...
var Vo = r(({ isSticky: e2, sticky: o2 }) => {
  let { token: s } = theme_default.useToken(), t = J(), { data: n2 } = $r({ v3LegacyAuthProviderCompatible: !!(t != null && t.isLegacy) });
  ...
  return S(o2, e2) && (a.position = "sticky", a.top = 0, a.zIndex = 1), import_react97.default.createElement(layout_default.Header, { style: a }, import_react97.default.createElement(space_default, null, import_react97.default.createElement(space_default, { size: "middle" }, (n2 == null ? void 0 : n2.name) && import_react97.default.createElement(typography_default.Text, { strong: true }, n2.name), (n2 == null ? void 0 : n2.avatar) && import_react97.default.createElement(avatar_default, { src: n2 == null ? void 0 : n2.avatar, alt: n2 == null ? void 0 : n2.name }))));
}, "ThemedHeaderV2");
var Zn = r(({ children: e2, Header: o2, Sider: s, Title: t, Footer: n2, OffLayoutArea: i, initialSiderCollapsed: a }) => {
  let d = grid_default.useBreakpoint(), u = s ?? Ro, y = o2 ?? Vo, l = typeof d.sm > "u" ? true : d.sm, g = !!u({ Title: t });
  return import_react95.default.createElement(xo, { initialSiderCollapsed: a }, import_react95.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: g }, import_react95.default.createElement(u, { Title: t }), import_react95.default.createElement(layout_default, null, import_react95.default.createElement(y, null), import_react95.default.createElement(layout_default.Content, null, import_react95.default.createElement("div", { style: { minHeight: 360, padding: l ? 24 : 12 } }, e2), i && import_react95.default.createElement(i, null)), n2 && import_react95.default.createElement(n2, null))));
}, "ThemedLayoutV2");
var sa2 = "Refine Project";
...
var ce2 = r(({ collapsed: e2, icon: o2 = na2, text: s = sa2, wrapperStyles: t }) => {
  let { token: n2 } = theme_default.useToken(), i = Z(), a = rt(), { Link: d } = te();
  return import_react98.default.createElement(i === "legacy" ? d : a, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react98.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...t } }, import_react98.default.createElement("div", { style: { height: "24px", width: "24px", color: n2.colorPrimary } }, o2), !e2 && import_react98.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, s)));
}, "ThemedTitleV2");
var Ho = r(({ resource: e2, resourceNameOrRouteName: o2, hideText: s = false, accessControl: t, meta: n2, children: i, onClick: a, ...d }) => {
  let { hidden: u, disabled: y, label: l, title: g, LinkComponent: m, to: f } = FD({ resource: e2 ?? o2, accessControl: t, meta: n2 });
...
var Oo = r(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, hideText: t = false, accessControl: n2, meta: i, children: a, onClick: d, ...u }) => {
  let { to: y, label: l, title: g, hidden: m, disabled: f, LinkComponent: b } = ID({ resource: e2 ?? o2, id: s, meta: i, accessControl: n2 });
  ...
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(EditOutlined_default, null), disabled: f, title: g, className: n.EditButton, ...u }, !t && (a ?? l)));
}, "EditButton");
var _e = r(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, onSuccess: t, mutationMode: n2, children: i, successNotification: a, errorNotification: d, hideText: u = false, accessControl: y, metaData: l, meta: g, dataProviderName: m, confirmTitle: f, confirmOkText: b, confirmCancelText: p, invalidates: T, ...P }) => {
  let { title: C, label: v, hidden: h, disabled: S2, loading: B, confirmTitle: L, confirmOkLabel: k, cancelLabel: c, onConfirm: E } = Du({ resource: e2 ?? o2, id: s, dataProviderName: m, invalidates: T, meta: g, onSuccess: t, mutationMode: n2, errorNotification: d, successNotification: a, accessControl: y });
  return h ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: b ?? k, cancelText: p ?? c, okType: "danger", title: f ?? L, okButtonProps: { disabled: B }, onConfirm: E, disabled: typeof (P == null ? void 0 : P.disabled) < "u" ? P.disabled : S2 }, import_react101.default.createElement(button_default, { danger: true, loading: B, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: C, disabled: S2, className: n.DeleteButton, ...P }, !u && (i ?? v)));
}, "DeleteButton");
var Ye = r(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, hideText: t = false, dataProviderName: n2, children: i, meta: a, metaData: d, ...u }) => {
  let { onClick: y, label: l, loading: g } = Uu({ resource: e2 ?? o2, id: s, dataProviderName: n2 });
  return import_react102.default.createElement(button_default, { onClick: y, icon: import_react102.default.createElement(RedoOutlined_default, { spin: g }), className: n.RefreshButton, ...u }, !t && (i ?? l));
}, "RefreshButton");
var Ra = r(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, hideText: t = false, accessControl: n2, meta: i, children: a, onClick: d, ...u }) => {
  let { to: y, label: l, title: g, hidden: m, disabled: f, LinkComponent: b } = wD({ resource: e2 ?? o2, id: s, accessControl: n2, meta: i });
  return m ? null : import_react103.default.createElement(b, { to: y, replace: false, onClick: (p) => {
    ...
    d && (p.preventDefault(), d(p));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: f, title: g, className: n.ShowButton, ...u }, !t && (a ?? l)));
}, "ShowButton");
var Ze = r(({ resource: e2, resourceNameOrRouteName: o2, hideText: s = false, accessControl: t, meta: n2, children: i, onClick: a, ...d }) => {
  let { to: u, label: y, title: l, hidden: g, disabled: m, LinkComponent: f } = AD({ resource: e2 ?? o2, accessControl: t, meta: n2 });
...
var ja = r(({ hideText: e2 = false, children: o2, ...s }) => {
  let { label: t } = QD();
  return import_react105.default.createElement(button_default, { type: "default", icon: import_react105.default.createElement(ExportOutlined_default, null), className: n.ExportButton, ...s }, !e2 && (o2 ?? t));
}, "ExportButton");
var Xe = r(({ hideText: e2 = false, children: o2, ...s }) => {
  let { label: t } = kD();
  return import_react106.default.createElement(button_default, { type: "primary", icon: import_react106.default.createElement(SaveOutlined_default, null), className: n.SaveButton, ...s }, !e2 && (o2 ?? t));
}, "SaveButton");
var ei = r(({ resourceNameOrRouteName: e2, resource: o2, recordItemId: s, hideText: t = false, accessControl: n2, meta: i, children: a, onClick: d, ...u }) => {
  let { to: y, LinkComponent: l, label: g, disabled: m, hidden: f, title: b } = SD({ id: s, resource: o2 ?? e2, accessControl: n2, meta: i });
  return f ? null : import_react107.default.createElement(l, { to: y, replace: false, onClick: (p) => {
    ...
    d && (p.preventDefault(), d(p));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: m, title: b, className: n.CloneButton, ...u }, !t && (a ?? g)));
}, "CloneButton");
var ii = r(({ uploadProps: e2, buttonProps: o2, hideText: s = false, children: t, loading: n2 }) => {
  let { label: i } = VD();
  return import_react108.default.createElement(upload_default, { ...e2 }, import_react108.default.createElement(button_default, { icon: import_react108.default.createElement(ImportOutlined_default, null), className: n.ImportButton, loading: n2, ...o2 }, !s && (t ?? i)));
}, "ImportButton");
var fi = r(({ canCreate: e2, title: o2, children: s, createButtonProps: t, resource: n2, wrapperProps: i, contentProps: a, headerProps: d, breadcrumb: u, headerButtonProps: y, headerButtons: l }) => {
  var S2, B;
  let g = G(), { options: { breadcrumb: m } = {} } = se(), f = Z(), b = st(), { resource: p, identifier: T } = z(n2), P = e2 ?? (((p == null ? void 0 : p.canCreate) ?? !!(p != null && p.create)) || t), C = typeof u > "u" ? m : u, v = P ? { size: "middle", resource: f === "legacy" ? p == null ? void 0 : p.route : T, ...t } : void 0, h = P ? import_react109.default.createElement(Ho, { ...v }) : null;
  return import_react109.default.createElement("div", { ...i ?? {} }, import_react109.default.createElement(Se, { ghost: false, title: o2 ?? g(`${T}.titles.list`, b(((S2 = p == null ? void 0 : p.meta) == null ? void 0 : S2.label) ?? ((B = p == null ? void 0 : p.options) == null ? void 0 : B.label) ?? (p == null ? void 0 : p.label) ?? T, "plural")), extra: l ? import_react109.default.createElement(space_default, { wrap: true, ...y }, typeof l == "function" ? l({ defaultButtons: h, createButtonProps: v }) : l) : h, breadcrumb: typeof C < "u" ? import_react109.default.createElement(import_react109.default.Fragment, null, C) ?? void 0 : import_react109.default.createElement(Be, null), ...d ?? {} }, import_react109.default.createElement("div", { ...a ?? {} }, s)));
}, "List");
var Bi = r(({ title: e2, saveButtonProps: o2, children: s, resource: t, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: d, contentProps: u, headerButtonProps: y, headerButtons: l, footerButtonProps: g, footerButtons: m, goBack: f }) => {
  var E, I;
  let b = G(), { options: { breadcrumb: p } = {} } = se(), T = Z(), P = uo(), { goBack: C } = ce(), v = st(), { resource: h, action: S2, identifier: B } = z(t), L = typeof i > "u" ? p : i, k = { ...n2 ? { disabled: true } : {}, ...o2, htmlType: "submit" }, c = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Xe, { ...k }));
  return import_react110.default.createElement("div", { ...a ?? {} }, import_react110.default.createElement(Se, { ghost: false, backIcon: f, onBack: S2 !== "list" || typeof S2 < "u" ? T === "legacy" ? C : P : void 0, title: e2 ?? b(`${B}.titles.create`, `Create ${v(((E = h == null ? void 0 : h.meta) == null ? void 0 : E.label) ?? ((I = h == null ? void 0 : h.options) == null ? void 0 : I.label) ?? (h == null ? void 0 : h.label) ?? B, "singular")}`), breadcrumb: typeof L < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, L) ?? void 0 : import_react110.default.createElement(Be, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...y ?? {} }, l ? typeof l == "function" ? l({ defaultButtons: null }) : l : null), ...d ?? {} }, import_react110.default.createElement(spin_default, { spinning: n2 }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...g ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: c, saveButtonProps: k }) : m : c)], ...u ?? {} }, s))));
}, "Create");
var Ai = r(({ title: e2, saveButtonProps: o2, mutationMode: s, recordItemId: t, children: n2, deleteButtonProps: i, canDelete: a, resource: d, isLoading: u = false, dataProviderName: y, breadcrumb: l, wrapperProps: g, headerProps: m, contentProps: f, headerButtonProps: b, headerButtons: p, footerButtonProps: T, footerButtons: P, goBack: C, autoSaveProps: v }) => {
  var J2, se2, ee;
  let h = G(), { options: { breadcrumb: S2 } = {} } = se(), { mutationMode: B } = Ae(), L = s ?? B, k = Z(), c = uo(), E = ge(), { goBack: I, list: U } = ce(), Z2 = st(), { resource: x, action: _, id: Q, identifier: H } = z(d), V = nu({ resource: x, action: "list" }), X = t ?? Q, F = typeof l > "u" ? S2 : l, D = (x == null ? void 0 : x.list) && !t, O = a ?? ((((J2 = x == null ? void 0 : x.meta) == null ? void 0 : J2.canDelete) ?? (x == null ? void 0 : x.canDelete)) || i), z2 = D ? { ...u ? { disabled: true } : {}, resource: k === "legacy" ? x == null ? void 0 : x.route : H } : void 0, Y = { ...u ? { disabled: true } : {}, resource: k === "legacy" ? x == null ? void 0 : x.route : H, recordItemId: X, dataProviderName: y }, G2 = O ? { ...u ? { disabled: true } : {}, resource: k === "legacy" ? x == null ? void 0 : x.route : H, mutationMode: L, onSuccess: () => {
    k === "legacy" ? U((x == null ? void 0 : x.route) ?? (x == null ? void 0 : x.name) ?? "") : E({ to: V });
  }, recordItemId: X, dataProviderName: y, ...i } : void 0, A = { ...u ? { disabled: true } : {}, ...o2 }, K = import_react111.default.createElement(import_react111.default.Fragment, null, v && import_react111.default.createElement(Ir, { ...v }), D && import_react111.default.createElement(Ze, { ...z2 }), import_react111.default.createElement(Ye, { ...Y })), j = import_react111.default.createElement(import_react111.default.Fragment, null, O && import_react111.default.createElement(_e, { ...G2 }), import_react111.default.createElement(Xe, { ...A }));
  return import_react111.default.createElement("div", { ...g ?? {} }, import_react111.default.createElement(Se, { ghost: false, backIcon: C, onBack: _ !== "list" && typeof _ < "u" ? k === "legacy" ? I : c : void 0, title: e2 ?? h(`${H}.titles.edit`, `Edit ${Z2(((se2 = x == null ? void 0 : x.meta) == null ? void 0 : se2.label) ?? ((ee = x == null ? void 0 : x.options) == null ? void 0 : ee.label) ?? (x == null ? void 0 : x.label) ?? H, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...b ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: K, listButtonProps: z2, refreshButtonProps: Y }) : p : K), breadcrumb: typeof F < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, F) ?? void 0 : import_react111.default.createElement(Be, null), ...m ?? {} }, import_react111.default.createElement(spin_default, { spinning: u }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...T ?? {} }, P ? typeof P == "function" ? P({ defaultButtons: j, deleteButtonProps: G2, saveButtonProps: A }) : P : j)], ...f ?? {} }, n2))));
}, "Edit");
var _i = r(({ title: e2, canEdit: o2, canDelete: s, isLoading: t = false, children: n2, resource: i, recordItemId: a, dataProviderName: d, breadcrumb: u, contentProps: y, headerProps: l, wrapperProps: g, headerButtons: m, footerButtons: f, footerButtonProps: b, headerButtonProps: p, goBack: T }) => {
  var Y, G2, A;
  let P = G(), { options: { breadcrumb: C } = {} } = se(), v = Z(), h = uo(), S2 = ge(), { goBack: B, list: L } = ce(), k = st(), { resource: c, action: E, id: I, identifier: U } = z(i), Z2 = nu({ resource: c, action: "list" }), x = a ?? I, _ = typeof u > "u" ? C : u, Q = (c == null ? void 0 : c.list) && !a, H = s ?? ((Y = c == null ? void 0 : c.meta) == null ? void 0 : Y.canDelete) ?? (c == null ? void 0 : c.canDelete), V = o2 ?? (c == null ? void 0 : c.canEdit) ?? !!(c != null && c.edit), X = Q ? { resource: v === "legacy" ? c == null ? void 0 : c.route : U } : void 0, F = V ? { ...t ? { disabled: true } : {}, type: "primary", resource: v === "legacy" ? c == null ? void 0 : c.route : U, recordItemId: x } : void 0, D = H ? { ...t ? { disabled: true } : {}, resource: v === "legacy" ? c == null ? void 0 : c.route : U, recordItemId: x, onSuccess: () => {
    v === "legacy" ? L((c == null ? void 0 : c.route) ?? (c == null ? void 0 : c.name) ?? "") : S2({ to: Z2 });
  }, dataProviderName: d } : void 0, O = { ...t ? { disabled: true } : {}, resource: v === "legacy" ? c == null ? void 0 : c.route : U, recordItemId: x, dataProviderName: d }, z2 = import_react112.default.createElement(import_react112.default.Fragment, null, Q && import_react112.default.createElement(Ze, { ...X }), V && import_react112.default.createElement(Oo, { ...F }), H && import_react112.default.createElement(_e, { ...D }), import_react112.default.createElement(Ye, { ...O }));
  return import_react112.default.createElement("div", { ...g ?? {} }, import_react112.default.createElement(Se, { ghost: false, backIcon: T, onBack: E !== "list" && typeof E < "u" ? v === "legacy" ? B : h : void 0, title: e2 ?? P(`${U}.titles.show`, `Show ${k(((G2 = c == null ? void 0 : c.meta) == null ? void 0 : G2.label) ?? ((A = c == null ? void 0 : c.options) == null ? void 0 : A.label) ?? (c == null ? void 0 : c.label) ?? U, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...p ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: z2, deleteButtonProps: D, editButtonProps: F, listButtonProps: X, refreshButtonProps: O }) : m : z2), breadcrumb: typeof _ < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, _) ?? void 0 : import_react112.default.createElement(Be, null), ...l ?? {} }, import_react112.default.createElement(spin_default, { spinning: t }, import_react112.default.createElement(card_default, { bordered: false, actions: f ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...b }, typeof f == "function" ? f({ defaultButtons: null }) : f)] : void 0, ...y ?? {} }, n2))));
}, "Show");
var Xi = r(({ value: e2, ...o2 }) => import_react113.default.createElement(typography_default.Text, { ...o2 }, e2), "TextField");
var ol = r(({ value: e2, ...o2 }) => import_react114.default.createElement(tag_default, { ...o2 }, e2 == null ? void 0 : e2.toString()), "TagField");
var sl = r(({ value: e2, ...o2 }) => import_react115.default.createElement(typography_default.Link, { href: `mailto:${e2}`, ...o2 }, e2), "EmailField");
var il = r(({ value: e2, imageTitle: o2, ...s }) => import_react116.default.createElement(image_default, { ...s, src: e2, title: o2 }), "ImageField");
var ul = r(({ value: e2, valueLabelTrue: o2 = "true", valueLabelFalse: s = "false", trueIcon: t = import_react117.default.createElement(CheckOutlined_default, null), falseIcon: n2 = import_react117.default.createElement(CloseOutlined_default, null), ...i }) => import_react117.default.createElement(tooltip_default, { title: e2 ? o2 : s, ...i }, e2 ? import_react117.default.createElement("span", null, t) : import_react117.default.createElement("span", null, n2)), "BooleanField");
var yl = r(({ value: e2, locales: o2, format: s = "L", ...t }) => {
  import_dayjs5.default.extend(import_localizedFormat.default);
  let n2 = import_dayjs5.default.locale();
  return import_react118.default.createElement(typography_default.Text, { ...t }, (0, import_dayjs5.default)(e2).locale(o2 || n2).format(s));
}, "DateField");
var gl = r(({ title: e2, src: o2, ...s }) => import_react119.default.createElement(Go, { value: o2, title: e2, ...s }, e2 ?? o2), "FileField");
var Go = r(({ children: e2, value: o2, ...s }) => import_react120.default.createElement(typography_default.Link, { href: o2, ...s }, e2 ?? o2), "UrlField");
function Cl() {
  return !!(typeof Intl == "object" && Intl && typeof Intl.NumberFormat == "function");
}
r(Cl, "toLocaleStringSupportsOptions");
var Fl = r(({ value: e2, locale: o2, options: s, ...t }) => {
  let n2 = Number(e2);
  return import_react121.default.createElement(typography_default.Text, { ...t }, Cl() ? n2.toLocaleString(o2, s) : n2);
}, "NumberField");
var Ll = r(({ value: e2 = "" }) => import_react122.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var Rl = r((e2) => {
  let { setSelectedKeys: o2, confirm: s, clearFilters: t, mapValue: n2, selectedKeys: i, children: a } = e2, [d, u] = (0, import_react123.useState)(i), y = G(), l = r(() => {
    t && (u([]), t());
  }, "clearFilter"), g = r(() => {
    let p = m(d), T;
    typeof p == "number" ? T = `${p}` : import_dayjs6.default.isDayjs(p) ? T = [p.toISOString()] : T = p, o2(T), s == null || s();
  }, "onFilter"), m = r((p) => n2 ? n2(p) : p, "mappedValue"), f = r((p) => {
    if (typeof p == "object") {
      if (Array.isArray(p)) {
        let h = m(p);
        return u(h), o2(h);
...
var Gl = r(() => {
  let [e2, o2] = (0, import_react124.useState)(), s = G(), { push: t } = ce(), n2 = ge(), i = Z(), { resource: a, action: d } = z();
...
var Mr = { background: "radial-gradient(50% 50% at 50% 50%, #63386A 0%, #310438 100%)", backgroundSize: "cover" };
var Nr = { maxWidth: "408px", margin: "auto" };
var Qr = { textAlign: "center", color: "#626262", fontSize: "30px", letterSpacing: "-0.04em" };
var zr = { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "28px" };
var op = r(() => {
  let [e2] = form_default.useForm(), o2 = G(), s = J(), { mutate: t, isLoading: n2 } = At({ v3LegacyAuthProviderCompatible: !!(s != null && s.isLegacy) }), i = import_react125.default.createElement(typography_default.Title, { level: 3, style: Qr }, o2("pages.login.title", "Sign in your account"));
  return import_react125.default.createElement(layout_default, { style: Mr }, import_react125.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react125.default.createElement(col_default, { xs: 22 }, import_react125.default.createElement("div", { style: Nr }, import_react125.default.createElement("div", { style: zr }, import_react125.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react125.default.createElement(card_default, { title: i, headStyle: { borderBottom: 0 } }, import_react125.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (a) => {
    t(a);
...
var we = { textAlign: "center", marginBottom: 0, fontSize: "24px", lineHeight: "32px", fontWeight: 700, overflowWrap: "break-word", hyphens: "manual", textOverflow: "unset", whiteSpace: "pre-wrap" };
var $o = r(({ providers: e2, registerLink: o2, forgotPasswordLink: s, rememberMe: t, contentProps: n2, wrapperProps: i, renderContent: a, formProps: d, title: u, hideForm: y }) => {
  let { token: l } = theme_default.useToken(), [g] = form_default.useForm(), m = G(), f = Z(), b = rt(), { Link: p } = te(), T = f === "legacy" ? p : b, P = J(), { mutate: C, isLoading: v } = At({ v3LegacyAuthProviderCompatible: !!(P != null && P.isLegacy) }), h = u === false ? null : import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, u ?? import_react128.default.createElement(ce2, { collapsed: false })), S2 = import_react128.default.createElement(typography_default.Title, { level: 3, style: { color: l.colorPrimaryTextHover, ...we } }, m("pages.login.title", "Sign in to your account")), B = r(() => e2 && e2.length > 0 ? import_react128.default.createElement(import_react128.default.Fragment, null, e2.map((k) => import_react128.default.createElement(button_default, { key: k.name, type: "default", block: true, icon: k.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => C({ providerName: k.name }) }, k.label)), !y && import_react128.default.createElement(divider_default, null, import_react128.default.createElement(typography_default.Text, { style: { color: l.colorTextLabel } }, m("pages.login.divider", "or")))) : null, "renderProviders"), L = import_react128.default.createElement(card_default, { title: S2, headStyle: ke, bodyStyle: Ee, style: { ...Le, backgroundColor: l.colorBgElevated }, ...n2 ?? {} }, B(), !y && import_react128.default.createElement(form_default, { layout: "vertical", form: g, onFinish: (k) => C(k), requiredMark: false, initialValues: { remember: false }, ...d }, import_react128.default.createElement(form_default.Item, { name: "email", label: m("pages.login.fields.email", "Email"), rules: [{ required: true, message: m("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: m("pages.login.errors.validEmail", "Invalid email address") }] }, import_react128.default.createElement(input_default, { size: "large", placeholder: m("pages.login.fields.email", "Email") })), import_react128.default.createElement(form_default.Item, { name: "password", label: m("pages.login.fields.password", "Password"), rules: [{ required: true, message: m("pages.login.errors.requiredPassword", "Password is required") }] }, import_react128.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, t ?? import_react128.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react128.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, m("pages.login.buttons.rememberMe", "Remember me"))), s ?? import_react128.default.createElement(T, { style: { color: l.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, m("pages.login.buttons.forgotPassword", "Forgot password?"))), !y && import_react128.default.createElement(form_default.Item, null, import_react128.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: v, block: true }, m("pages.login.signin", "Sign in")))), o2 ?? import_react128.default.createElement("div", { style: { marginTop: y ? 16 : 8 } }, import_react128.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, m("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react128.default.createElement(T, { to: "/register", style: { fontWeight: "bold", color: l.colorPrimaryTextHover } }, m("pages.login.signup", "Sign up")))));
...
var _o = r(({ providers: e2, loginLink: o2, wrapperProps: s, contentProps: t, renderContent: n2, formProps: i, title: a, hideForm: d }) => {
  let { token: u } = theme_default.useToken(), [y] = form_default.useForm(), l = G(), g = Z(), m = rt(), { Link: f } = te(), b = g === "legacy" ? f : m, p = J(), { mutate: T, isLoading: P } = _r({ v3LegacyAuthProviderCompatible: !!(p != null && p.isLegacy) }), C = a === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react129.default.createElement(ce2, { collapsed: false })), v = import_react129.default.createElement(typography_default.Title, { level: 3, style: { color: u.colorPrimaryTextHover, ...we } }, l("pages.register.title", "Sign up for your account")), h = r(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((B) => import_react129.default.createElement(button_default, { key: B.name, type: "default", block: true, icon: B.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => T({ providerName: B.name }) }, B.label)), !d && import_react129.default.createElement(divider_default, null, import_react129.default.createElement(typography_default.Text, { style: { color: u.colorTextLabel } }, l("pages.login.divider", "or")))) : null, "renderProviders"), S2 = import_react129.default.createElement(card_default, { title: v, headStyle: ke, bodyStyle: Ee, style: { ...Le, backgroundColor: u.colorBgElevated }, ...t ?? {} }, h(), !d && import_react129.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (B) => T(B), requiredMark: false, ...i }, import_react129.default.createElement(form_default.Item, { name: "email", label: l("pages.register.email", "Email"), rules: [{ required: true, message: l("pages.register.errors.requiredEmail", "Email is required") }, { type: "email", message: l("pages.register.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: l("pages.register.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: l("pages.register.fields.password", "Password"), rules: [{ required: true, message: l("pages.register.errors.requiredPassword", "Password is required") }] }, import_react129.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, o2 ?? import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, l("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(b, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, l("pages.login.signin", "Sign in")))), import_react129.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: P, block: true }, l("pages.register.buttons.submit", "Sign up")))), d && o2 !== false && import_react129.default.createElement("div", { style: { marginTop: d ? 16 : 8 } }, import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, l("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(b, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, l("pages.login.signin", "Sign in")))));
  return import_react129.default.createElement(layout_default, { style: ve, ...s ?? {} }, import_react129.default.createElement(row_default, { justify: "center", align: d ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: d ? "15dvh" : "16px" } }, import_react129.default.createElement(col_default, { xs: 22 }, n2 ? n2(S2, C) : import_react129.default.createElement(import_react129.default.Fragment, null, C, S2))));
}, "RegisterPage");
var Yo = r(({ loginLink: e2, wrapperProps: o2, contentProps: s, renderContent: t, formProps: n2, title: i }) => {
  let { token: a } = theme_default.useToken(), [d] = form_default.useForm(), u = G(), y = Z(), l = rt(), { Link: g } = te(), m = y === "legacy" ? g : l, { mutate: f, isLoading: b } = Xr(), p = i === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react130.default.createElement(ce2, { collapsed: false })), T = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: a.colorPrimaryTextHover, ...we } }, u("pages.forgotPassword.title", "Forgot your password?")), P = import_react130.default.createElement(card_default, { title: T, headStyle: ke, bodyStyle: Ee, style: { ...Le, backgroundColor: a.colorBgElevated }, ...s ?? {} }, import_react130.default.createElement(form_default, { layout: "vertical", form: d, onFinish: (C) => f(C), requiredMark: false, ...n2 }, import_react130.default.createElement(form_default.Item, { name: "email", label: u("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true, message: u("pages.forgotPassword.errors.requiredEmail", "Email is required") }, { type: "email", message: u("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { type: "email", size: "large", placeholder: u("pages.forgotPassword.fields.email", "Email") })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, u("pages.register.buttons.haveAccount", "Have an account? "), " ", import_react130.default.createElement(m, { style: { fontWeight: "bold", color: a.colorPrimaryTextHover }, to: "/login" }, u("pages.login.signin", "Sign in")))), import_react130.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: b, block: true }, u("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react130.default.createElement(layout_default, { style: ve, ...o2 ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react130.default.createElement(col_default, { xs: 22 }, t ? t(P, p) : import_react130.default.createElement(import_react130.default.Fragment, null, p, P))));
}, "ForgotPasswordPage");
var Zo = r(({ wrapperProps: e2, contentProps: o2, renderContent: s, formProps: t, title: n2 }) => {
  let { token: i } = theme_default.useToken(), [a] = form_default.useForm(), d = G(), u = J(), { mutate: y, isLoading: l } = Yr({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), g = n2 === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react131.default.createElement(ce2, { collapsed: false })), m = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: i.colorPrimaryTextHover, ...we } }, d("pages.updatePassword.title", "Set New Password")), f = import_react131.default.createElement(card_default, { title: m, headStyle: ke, bodyStyle: Ee, style: { ...Le, backgroundColor: i.colorBgElevated }, ...o2 ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: a, onFinish: (b) => y(b), requiredMark: false, ...t }, import_react131.default.createElement(form_default.Item, { name: "password", label: d("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true, message: d("pages.updatePassword.errors.requiredPassword", "Password is required") }], style: { marginBottom: "12px" } }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { name: "confirmPassword", label: d("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true, message: d("pages.updatePassword.errors.requiredConfirmPassword", "Confirm password is required") }, ({ getFieldValue: b }) => ({ validator(p, T) {
...
var ad = r((e2) => {
  let { type: o2 } = e2;
  return import_react127.default.createElement(import_react127.default.Fragment, null, r(() => {
    switch (o2) {
      case "register":
      ...
      default:
        return import_react127.default.createElement($o, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var Be = r(({ breadcrumbProps: e2, showHome: o2 = true, hideIcons: s = false, meta: t }) => {
  let n2 = Z(), { breadcrumbs: i } = Yb({ meta: t }), a = rt(), { Link: d } = te(), { hasDashboard: u } = se(), { resources: y } = z(), l = Ko("/", y), g = n2 === "legacy" ? d : a;
  if (i.length === 1)
    return null;
  ...
  return import_react132.default.createElement(breadcrumb_default, { items: r(() => {
    var b, p;
...
var Se = r(({ children: e2, ...o2 }) => {
  let s = typeof o2.backIcon > "u" ? import_react133.default.createElement(button_default, { type: "text", icon: import_react133.default.createElement(ArrowLeftOutlined_default, null) }) : o2.backIcon, t = typeof o2.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.Title, level: 4, style: { marginBottom: 0 } }, o2.title) : o2.title, n2 = typeof o2.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.SubTitle, level: 5, type: "secondary", style: { marginBottom: 0 } }, o2.subTitle) : o2.subTitle;
  return import_react133.default.createElement(PageHeader, { ...o2, backIcon: s, title: t, subTitle: n2, style: { padding: 0, ...o2.style } }, e2);
}, "PageHeader");
var Ir = r(({ status: e2, elements: { success: o2 = import_react134.default.createElement(uo2, { key: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: s = import_react134.default.createElement(uo2, { key: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: t = import_react134.default.createElement(uo2, { key: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: n2 = import_react134.default.createElement(uo2, { key: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(cc, { status: e2, elements: { success: o2, error: s, loading: t, idle: n2 } }), "AutoSaveIndicator");
var uo2 = r(({ key: e2, defaultMessage: o2, icon: s }) => {
  let t = G(), { token: n2 } = theme_default.useToken();
  return import_react134.default.createElement(typography_default.Text, { style: { marginRight: 5, color: n2.colorTextTertiary, fontSize: ".8rem" } }, t(e2, o2), import_react134.default.createElement("span", { style: { marginLeft: ".2rem" } }, s));
}, "Message");
var Ld = r((e2) => {
  let { fileList: o2 } = e2;
  return [...o2];
...
export {
  ...
  Go as UrlField,
  mp as WelcomePage,
  Lt as getDefaultFilter,
  vt as getDefaultSortOrder,
